...
const Footer = () => {
    ...
    <div className="max-w-7xl mx-auto px-4 py-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
      <div>
        ...
        <div className="flex gap-2 mt-4">
          <a href="#"><img src="https://cdn.shopify.com/s/files/1/0282/2858/3562/files/google-play.png" alt="Google Play" className="h-10" /></a>
          <a href="#"><img src="https://cdn.shopify.com/s/files/1/0282/2858/3562/files/app-store.png" alt="App Store" className="h-10" /></a>
        </div>
      </div>
      ...
      <div>
        ...
        <a href="https://goo.gl/maps/9nRR47Z2qstkfTyP8" target="_blank">
          <img src="https://vela-develop.myshopify.com/cdn/shop/files/footer-map.png?v=1613731231" alt="map" className="rounded-lg" />
        </a>
      </div>
    </div>
  ...
  <div  className="bg-gray-900  py-4 text-sm text-gray-400 ">
  <div className="container ">
    <div className="footer-bottom__innerflex ">
      <div className="footer-copyright ">Copyright &copy; 2020 Velatheme. All Rights Reserved</div>
      <div className="payment-icons">
            <span className="sr-only ">Payment methods</span>
            <ul className="payment-icons__list"><li>
