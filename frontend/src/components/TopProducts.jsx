    ...
    <div className="bg-white rounded-lg shadow hover:shadow-md transition-all duration-300 overflow-hidden">
      ...
      <div className="p-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-red-600 font-semibold text-base">{product.price}</span>
        </div>
      </div>
    </div>
  );
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
          <div className="text-center">
            <h1 className="text-2xl font-bold text-gray-800 mb-4">TOP PRODUCTS</h1>
            <div className="flex flex-wrap justify-center gap-2 sm:gap-4">
              {['bestselling', 'featured', 'new'].map(tab => (
                ...
                >
                  {tab === 'bestselling' ? 'Best Selling' : tab === 'featured' ? 'Featured' : 'New Products'}
                </button>
              ))}
            </div>
          </div>
